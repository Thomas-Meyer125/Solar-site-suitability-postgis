...
Graduated suitability ramp (orange → red)

Top 10 parcels highlighted (gold + bold outline)

Clean legend + inset regional map

300 dpi export for publication-quality output
